  ...
  it("normalizes a cahier de textes day detail payload", () => {
        ...
        matieres: [
          {
            ...
            aFaire: {
              ...
              ressourceDocuments: [{ libelle: "Consignes audio.mp3", url: "//doc1.ecoledirecte.com/audio.mp3", type: "audio/mpeg" }],
              documents: [
                { id: 88, libelle: "Lexique.pdf", urlFichier: "https://doc1.ecoledirecte.com/lexique.pdf", unc: "unc-lexique" },
    ...
    expect(result.data?.subjects[0]).toMatchObject({
      ...
      homework: {
        ...
        resourceDocuments: [{ name: "Consignes audio.mp3", url: "https://doc1.ecoledirecte.com/audio.mp3", type: "audio/mpeg" }],
        documents: [
          { id: 88, name: "Lexique.pdf", url: "https://doc1.ecoledirecte.com/lexique.pdf", unc: "unc-lexique" },
          { id: 2489, downloadId: "2489", name: "BILAN TrimII.docx", type: "FICHIER_CDT" },
        ],
        submittedDocuments: [{ name: "Rendu.txt", url: "/piecejointe/rendu.txt" }],
        tags: ["Quiz"],
      },
      lessonContent: {
        lessonId: 4579,
        html: "<p>Cours</p>",
        documents: [{ name: "Cours.pdf", url: "https://doc1.ecoledirecte.com/cours.pdf" }],
      },
    });
